...
public class ProgramService {
	public List<Program> getListProgram() {		
		...
		listProgram.add(new Program(
				"1", 
				" Xem phim đầu xuân",
				"Nhân dịp năm mơi, Galaxy hân hạnh mang ưu đãi 'Đón xuân an lành': Hãy chech-in phim 'Diếp Vấn 3' tại Galaxy Hùng Vương hoặc Galaxy Tân Bình để có thể được xem phim với giá ưu đãi. Giảm giá vé 10% cho mỗi phim trên tại các rạp Galaxy trên địa bàn thành phố!", 
				"01/01/2015", 
				"31/01/2015", 
				"Galaxy Hùng Vương", 0, 0, 1, 0));
...
//				"Galaxy Cinema", 0, 5, 3));
	...
	public List<Mission> getListMission(String id) throws JSONException {
		...
		if (id.equals("1")) {
			...
			((MissionGPS)target1).setAddress("126 Tản Đà; 1 Nguyễn Hồng Đào;");
			return listMission;
		}
