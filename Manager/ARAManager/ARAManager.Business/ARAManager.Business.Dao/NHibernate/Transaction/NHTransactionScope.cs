...
namespace ARAManager.Business.Dao.NHibernate.Transaction
{
    ...
    public class NhTransactionScope : IDisposable
    {
        ...
        ///     cache is located.
        /// </summary>
        [ThreadStatic] private static NhTransactionScope s_currentScope;
        ...
        /// </remarks>
        public NhTransactionScope() : this(TransactionScopeOption.Required)
        {
        }
        ...
        /// </param>
        public NhTransactionScope(System.Transactions.Transaction transactionToUse)
            : this(transactionToUse, TimeSpan.Zero)
        {
        }
        ...
        {
            get { return m_cachedCurrentTransaction; }
        }
        ...
        {
            foreach (var session in m_sessionCache.Values)
            {
        ...
        {
            var factory = GetSessionFactory();
            var session = factory.CreateSession(connectionAlias);
            return session;
        }
        ...
        private void ClearSessionCache()
        {
            ...
            foreach (var pair in m_sessionCache)
            {
