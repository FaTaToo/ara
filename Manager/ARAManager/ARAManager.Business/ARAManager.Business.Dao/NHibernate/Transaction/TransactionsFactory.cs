...
namespace ARAManager.Business.Dao.NHibernate.Transaction
{
    ...
    public static class TransactionsFactory
    {
        ...
        /// <summary>
        ///     Create a transaction scope with default options. If forceNewScope is true, creates a new scope/new
        ///     session/transaction.
        /// </summary>
        ...
        public static NhTransactionScope CreateTransactionScope(bool forceNewScope, TimeSpan timeout)
        {
            ...
            var scopeoptions = forceNewScope ? TransactionScopeOption.RequiresNew : TransactionScopeOption.Required;
            var transOptions = GetTransactionOptions(timeout);
