        ...
        #region Constants
            ...
            #region ExceptionMessages
               ...
               "The phone has already been registered.";
                ...
                #region Account
                public const string ACCOUNT_CONCURRENT_UPDATE_EXCEPTION_MSG = 
                "The account has been edited by another.";
                public const string ACCOUNT_DELETED_EXCEPTION_MSG = 
                "The account has been already deleted.";
                #endregion Account

                #region AccountType
                public const string ACCOUNTTYPE_CONCURRENT_UPDATE_EXCEPTION_MSG =
                "The account type has been edited by another.";
                public const string ACCOUNTTYPE_DELETED_EXCEPTION_MSG = 
                "The account type has been already deleted.";
                public const string ACCOUNTTYPE_NAME_CONSTRAINT_EXCEPTION_MSG = 
                "The account type name has already existed.";
