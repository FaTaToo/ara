...
namespace ARAManager.Presentation.Connectivity
{
    ...
    public class ClientServiceFactory
    {
        ...
        private ClientServiceFactory()
        {
            ...
            {
                ExeConfigFilename = @"D:\Projects\ARA\1.0\src\Manager\ARAManager\ARAManager.Presentation\ARAManager.Presentation\bin\Debug\ARAManager.Presentation.exe.config",
